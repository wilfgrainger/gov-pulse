...
|---|---:|---|---|
| Government debt outstanding | 2024 | IMF World Economic Outlook April 2026, general-government gross debt as % GDP plus current-price GDP per capita | `% GDP × GDP per resident` |
...
| Public social expenditure | 2024 estimate | OECD SOCX public social expenditure as % GDP | `% GDP × GDP per resident` |
...
- 2025 ODA, 2025 defence and 2024 SOCX observations are labelled `estimate`.
- Debt, health, tax and debt-interest observations in this publication are labelled `historical`.
